"""Hybrid aggregated family descriptors."""
...
@register("hybrid", family="hybrid")
class HybridDescriptor(BaseDescriptor):
    """Hybrid aggregated family summary descriptors.
    ...
    def compute_one(self, sequence: str) -> dict[str, float]:
        """Compute hybrid family features for a single sequence."""

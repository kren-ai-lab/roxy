...
from roxy.sequence.families.aaindex import aaindex_mean_descriptors
from roxy.sequence.families.composition import aac_descriptors
from roxy.sequence.families.global_basic import global_basic_descriptors
from roxy.sequence.families.grouped import grouped_fraction_descriptors
from roxy.sequence.families.kmers import dpc_descriptors

from . import SequenceFeatureMap
...
# - Add future sequence-only families such as general `kmers`, `terminal`, `ctd`,
